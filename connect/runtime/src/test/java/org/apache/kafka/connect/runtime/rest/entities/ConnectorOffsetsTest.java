...
public class ConnectorOffsetsTest {
    ...
    public void testConnectorOffsetsToMap() {
        // Using arbitrary partition and offset structures here to demonstrate that source connector offsets don't
        // follow a standard pattern
        Map<String, Object> partition1 = new HashMap<>();
        partition1.put("partitionKey1", Arrays.asList("abc", "123"));
        partition1.put("k", "v");
        Map<String, Object> offset1 = new HashMap<>();
        offset1.put("offset", Collections.singletonMap("key", 100));
        ConnectorOffset connectorOffset1 = new ConnectorOffset(partition1, offset1);

        Map<String, Object> partition2 = new HashMap<>();
        partition2.put("partitionKey1", Arrays.asList("xyz", "789"));
        Map<String, Object> offset2 = new HashMap<>();
        offset2.put("offset", Collections.singletonMap("key", 200));
